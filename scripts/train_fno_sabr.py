"""
train_fno_sabr.py — Trains FNO model for the SABR model (param_dim=3).

Loads SABRDataset_v1.npz and normalizers, trains MirrorPaddedFNO2d with param_dim=3.
Saves model weights to artifacts/weights/fno_sabr_best.pth and final product weights.
"""
...
NORM_PARAM = "artifacts/models/param_normalizer_sabr.npz"
NORM_IV = "artifacts/models/iv_normalizer_sabr.npz"
...
def train():
    ...
    print(f"  Training SABR FNO on: {device}")
    ...
    params = data["params"]  # (N, 3): [alpha, rho, nu]
    iv = data["iv"]          # (N, 8, 11)
